<form id=dateForm class="row mr-2" action="<?php echo  base_url().'index.php/kasir_penjualan/cetakPenjualan'?>" method="post" target="_blank">
    ...
    <button type="button" onclick="get_Penjualan()" class="btn btn-success ml-1"><span class="fas fa-sync-alt mr-1" style="color:#ffff"></span></button>
    <button type="submit"  class="btn btn-primary ml-2"><span class="fas fa-print mr-1" style="color:#ffff"></span></button>
</form>